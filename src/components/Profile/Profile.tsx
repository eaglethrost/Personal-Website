...
export default function Profile() {
    return (
        <section id="profile" className="h-section bg-[#EDEDED]">
            <div id="profile-container" className="h-full flex lg:flex-row flex-col">
                <div id="face-container" className="basis-2/5 relative flex lg:items-center lg:justify-end justify-center">
                    <Image
                        src={MyFace}
                        alt="My Face"
