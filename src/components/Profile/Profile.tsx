    ...
    return (
        <section id="profile" className="min-h-screen tall-screen:min-h-[80vh] flex lg:flex-row flex-col justify-center bg-[#EDEDED]">
            ...
            <div id="about-container" className="basis-3/5 lg:pl-10 pt-2 relative flex flex-col lg:items-start items-center text-black">
                ...
                <span className="profile-about-desc lg:text-start text-center animate-fadeInDown3 anim-fm-back">I’m currently working as a forward deployed engineer building for the coolest startups!</span>
