...
export default function Projects({
  ...
  const defaultProjects: ProjectCardProps[] = [
    ...
    },
    {
      ...
      codeLink:
        "https://github.com/unsw-cse-comp99-3900/capstone-project-9900f11adothebest",
    },
    {
  ...
  return (
    <section id="projects" className="pb-10 bg-white">
      <h1 id="projects-intro" className="relative section-header pb-6">
        {title}
      </h1>
      <div
        id="projects-container"
        className="flex flex-row flex-wrap justify-evenly gap-12"
      >
